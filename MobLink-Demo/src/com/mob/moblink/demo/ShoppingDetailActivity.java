...
public class ShoppingDetailActivity extends BaseActivity {
	...
	private void getMobIDToShare() {
		...
		Scene s = new Scene();
		s.setPath(CommonUtils.SHOPPING_PATH);
		s.setParams(params);
	...
	private void share() {
		String shareUrl = CommonUtils.getShareUrl() + CommonUtils.SHOPPING_PATH + "/" + goodsID;
		if (!TextUtils.isEmpty(mobID)) {
...
//				String value = null;
//				if (scene.getParams().containsKey("goodsID")) {
//					value = String.valueOf(scene.getParams().get("goodsID"));
//
