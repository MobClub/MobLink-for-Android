...
public class ActivityB extends Activity implements View.OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		tvActTitle.setText(R.string.activity_b);
		tvActText.setText(R.string.activity_text_b);

		ivBack.setOnClickListener(this);
		btnCheckParams.setOnClickListener(this);

		path = CommonUtils.MAIN_PATH_ARR[1];
	}
	...
	protected void onResume() {
		...
		MobLink.setIntentHandler(getIntent(), new ActionListener() {
			public void onResult(final HashMap<String, Object> res) {
				runOnUiThread(new Runnable() {
					public void run() {
						...
						if (dialog == null) {
							dialog = CommonUtils.getDialog(ActivityB.this, path, source, paramStr);
						}
						if (!dialog.isShowing()) {
							dialog.show();
						}
			...
			public void onError(Throwable t) {
				if (t != null) {
					Toast.makeText(ActivityB.this, t.getMessage(), Toast.LENGTH_SHORT).show();
				}
			}
		});
